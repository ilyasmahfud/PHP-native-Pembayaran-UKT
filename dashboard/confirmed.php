                ...
                <div class="col-lg-12">
                    <div class="card h-100">
                        ...
                        <div class="card-body p-3 pb-0">
                            <table class="table is-striped" id="tables" style="border: none">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    if ($hasilQueryAll = mysqli_query($koneksi, $queryAllMahaasiswa)) {
                                        while ($dataAll = mysqli_fetch_array($hasilQueryAll)) {
                                            $mahasiswa1[] = [
                                                $dataAll['foto_profil'], $dataAll['nama_mahasiswa'], $dataAll['email'], $dataAll['username'], $dataAll['id_univ'], $dataAll['NIM']
                                            ];
                                        }
                                        ...
                                        <tr  style='border: none'>
                                            <td>
                                                ...
                                                <div>
                                                    <img src='" . $value[0] . "' class='avatar avatar-sm me-3' alt='user1'>
                                                </div>
                                                <div class='d-flex flex-column justify-content-center'>
                                                    <h6 class='mb-0 text-sm'>" . $value[1] . "</h6>
                                                    <p class='text-xs text-secondary mb-0'>" . $value[2] . "</p>
                                                </div>
                                                </div>
                                            </td>
                                            <td>
                                                <p class='text-xs font-weight-bold mb-0'>" . $value[5] . "</p>
                                                </td>
                                            <td class='align-middle text-center text-sm'>
                                                <p class='text-xs text-secondary mb-0'>" . $value[3] . "</p>
                                            </td>
                                        ...
                                        <!-- Modal -->
                                        <div class='modal fade' id='modal1" . $i . "' tabindex='-11' role='dialog' aria-labelledby='exampleModalMessageTitle' aria-hidden='true'>
                                        <div class='modal-dialog modal-dialog-centered' role='document'>
                                            <div class='modal-content'>
                                            <div class='modal-header'>
                                                <h5 class='modal-title' id='exampleModalLabel'>Sudah saatnya pembayaran UKT " . $value[1] . " Yaa?</h5>
                                            ...
                                            <div class='modal-body'>
                                                ...
                                                <div class='form-group'>
                                                    ...
                                                    <input name='nama_univ' disabled class='form-control' id='message-text' value='" . $value[5] . "' </input>
                                                </div>
