  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  active" href='billing.php?username=<?php echo $username ?>'>
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <div class="overflow-hidden position-relative border-radius-xl" style="background-image: url('assets/img/curved-images/curved14.jpg');">
                  ...
                  <div class="card-body position-relative z-index-1 p-3">
                    ...
                    <div class="d-flex">
                      <div class="d-flex">
                        <div class="me-4">
                          <p class="text-white text-sm opacity-8 mb-0">Halooo!</p>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="card">
                    ...
                    <div class="card-body pt-0 p-3 text-center">
                      <h6 class="text-center mb-0">Universitas</h6>
                      <span class="text-xs">Jumlah universitas terdaftar</span>
                      <hr class="horizontal dark my-3">
                      <h5 class="mb-0"><?php echo 2000 + $dataCountUniv['banyaknya_univ'] ?></h5>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 mt-md-0 mt-4">
                  <div class="card">
                    ...
                    <div class="card-body pt-0 p-3 text-center">
                      <h6 class="text-center mb-0">Transaksi</h6>
                      <span class="text-xs">Jumlah transaksi hingga kini</span>
                      <hr class="horizontal dark my-3">
                      <h5 class="mb-0">Rp. <?php echo $dataJumlahTransaksi['jumlah_transaksi'] ?></h5>
                    </div>
                  </div>
                </div>
              </div>
                            ...
                            <div class="modal-body p-0">
                              <div class="card card-plain">
                                <div class="card-header pb-0 text-left">
                                  <h5 class="font-weight-bolder text-primary text-gradient">Tambahkan Universitas</h5>
                                  <small class="mb-0">Pastikan NIU sudah benar</small>
                                </div>
                                <div class="card-body pb-3">
                                  <form role="form text-left" action='process/tambahUniv.php?'>
                                    <label>Nomor Induk Universitas (NIU)</label>
                                    <div class="input-group mb-3">
                                      <input name="NIU" type="text" class="form-control" placeholder="NIU" aria-label="Name" aria-describedby="name-addon">
                                    </div>
                                    <label>Nama Universitas</label>
                                    <div class="input-group mb-3">
                                      <input name="nama_univ" type="text" class="form-control" placeholder="Nama Universitas" aria-label="Password" aria-describedby="password-addon">
                                    </div>
                                    <input name="username" type="text" value='<?php echo $username ?>' style="display: none">
                                    <div class="text-center">
                                      <button type="submit" class="btn bg-gradient-primary btn-lg btn-rounded w-100 mt-4 mb-0">Tambahkan</button>
                                    </div>
                                  </form>
                                </div>
                              </div>
        ...
        <div class="col-md-7 mt-4">
          <div class="card">
            <div class="card-header pb-0 px-3">
              <h6 class="mb-0">Butuh Konfirmasi</h6>
            </div>
